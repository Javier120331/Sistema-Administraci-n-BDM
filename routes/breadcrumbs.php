...
//Home > Buscador de Trabajadores
Breadcrumbs::register('buscador', function($breadcrumbs)
{
    $breadcrumbs->parent('home');
    $breadcrumbs->push('Buscador de Trabajadores', action('BuscadorTrabajadoresController@index'));
});

//Home > Buscador de Trabajadores > Detalle
Breadcrumbs::register('buscadorDetalle', function($breadcrumbs, $nombre)
{
    $breadcrumbs->parent('buscador');
    $breadcrumbs->push('Detalle: ' . $nombre, '');
});
